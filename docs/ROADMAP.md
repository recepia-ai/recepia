...
### 1.2 PC-W9A — Observabilidad + regresiones

PC-W9A queda en **GO** con un dataset dorado ejecutable para web, WhatsApp y
...
| 2026-09-26 | 2.0 | Marc + Codex | PC-W9D queda en GO técnico condicionado: cada `assistant-request` impone grabación OFF manteniendo transcript/logs, se elimina la persistencia de URLs, y se documentan acceso, borrado, consentimiento y reproducción segura. No se habilita audio ni se modifica Production. |
